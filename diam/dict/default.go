...
<diameter>
    ...
    <application id="16777238" type="auth" name="TGPP Gx">
...
<diameter>
	<application id="4" type="auth" name="TGPP RORF">
		<vendor id="10415" name="TGPP"/>
...
<diameter>
    ...
    -->
    <application id="16777236" type="auth" name="TGPP Rx">
        <vendor id="10415" name="TGPP"/>
        <command code="265" short="AA" name="AA">
            <request>
                <rule avp="Session-Id" required="true" max="1"/>
        ...
        <command code="258" short="RA" name="Re-Auth">
            <request>
                ...
                <rule avp="FGS-RAN-NAS-Release-Cause" required="false"/>
                <rule avp="TGPP-SGSN-MCC-MNC" required="false" max="1"/>
                <rule avp="NID" required="false" max="1"/>
        ...
        <avp name="FGS-RAN-NAS-Release-Cause" code="572" vendor-id="10415" must="V" may-encrypt="Y">
            <data type="Grouped">
                <rule avp="FGMM-Cause" required="false" max="1"/>
                <rule avp="FGSM-Cause" required="false" max="1"/>
                <rule avp="NGAP-Cause" required="false" max="1"/>
                <rule avp="AVP" required="false"/>
            </data>
        </avp>

        <avp name="FGMM-Cause" code="573" vendor-id="10415" must="V" may-encrypt="Y">
            <data type="Unsigned32"/>
        </avp>

        <avp name="FGSM-Cause" code="574" vendor-id="10415" must="V" may-encrypt="Y">
            <data type="Unsigned32"/>
        </avp>
        ...
        <avp name="IP-CAN-Type" code="1027" must="M,V" may-encrypt="Y" vendor-id="10415">
            <data type="Enumerated">
                <item code="0" name="TGPP-GPRS"/>
                <item code="1" name="DOCSIS"/>
                <item code="2" name="xDSL"/>
                <item code="3" name="WiMAX"/>
                <item code="4" name="TGPP2"/>
                <item code="5" name="TGPP-EPS"/>
                <item code="6" name="Non-3GPP-EPS"/>
                <item code="7" name="FBA"/>
                <item code="8" name="TGPP-5GS"/>
                <item code="9" name="Non-3GPP-5GS"/>
            </data>
        </avp>
